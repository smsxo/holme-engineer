 ...
 * Renders a branded card with the logo mark, company name, tagline, and
 * trust badges (200+ systems, 30+ countries, 99.9% uptime).
 *
 * Next.js automatically serves this at /opengraph-image and wires it into
 * the <meta property="og:image"> tag for all pages that don't override it.
 */
export default function OGImage() {
  return new ImageResponse(
    ...
    >
      ...
      {/* Logo mark — geometric HE monogram */}
      <div
        style={{
          display: "flex",
          alignItems: "center",
